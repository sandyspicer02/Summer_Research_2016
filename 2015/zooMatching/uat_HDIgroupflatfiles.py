...
'''
  ...
  PROCEDURE:
  - make sure to run uat_HDIfixheader.py first
  ...
  - Overscan subtract and trim images (we assume these image names begin with htr*
...
os.system('gethead htr*f00.fits CMMTOBS FILTER > junkfile')
